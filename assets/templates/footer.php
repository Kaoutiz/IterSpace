    ...
    <div class="container">
        ...
        <div>
            ...
            <form>
                ...
                <button class="rounded-btn">Abonnez-vous</button>
            </form>
        </div>
    </div>
    <div class="container">
        <div>
            ...
            <div>
                ...
                <a href="https://www.spacex.com" target="_blank" title="Site de SpaceX"><img id="spacex-logo" src="./assets/img/SpaceX-Logo.svg" alt="Logo de Space X" width="64" height="64"></a>
            </div>
        </div>
    </div>
</footer>